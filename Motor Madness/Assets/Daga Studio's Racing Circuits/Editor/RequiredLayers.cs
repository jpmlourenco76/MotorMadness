...
public static class RequiredLayers {
    ...
    private const string MENU_ITEM = "Tools/Sync Layers";
    ...
    private static void Init() {
        ...
        if (EditorUtility.DisplayDialog("Adding New Layers",
                ...
                " The asset won't function has intented without these layers.", "Yes", "No")) {
            SyncLayers();
        } else {
            AlreadyAsked = true;
        }
    ...
    private static void SyncLayers() {
        ...
        EditorUtility.DisplayDialog(
            "Layers were added",
            "All the neccessaty layers have been added to the project",
            "OK"
        );
    }
